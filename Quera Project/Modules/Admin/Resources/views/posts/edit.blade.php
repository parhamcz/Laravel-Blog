                                    ...
                                    <form class="form-horizontal" action="{{ route('posts.update', ['post' => $post->id]) }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control eninputs{{ $errors->has('slug') ? ' is-invalid' : '' }}" name="slug" id="slug" value="{{ $post->slug }}">
                                        ...
                                        <div class="row pt-2">
                                                            ...
                                                            @foreach($categories as $category)
                                                                <li data-id="{{ $category->id }}">
                                                                    @if(count($category->subcategories))
                                                                        ...
                                                                        <label>
                                                                            <input name="categories[]" value="{{ $category->id }}" id="xnode-{{ $category->id }}" data-id="custom-{{ $category->id }}" type="checkbox" @if( in_array($category->id, $post->categories->pluck('id')->toArray()) ) checked @endif> {{ $category->name }}
                                                                        </label>
                                                                        <ul>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <select class="form-select w-100 ltr" name="tags[]" id="tags" multiple="multiple">
                                                    @foreach($tags as $tag)
                                                        <option value="{{ $tag->id }}" {{ in_array(trim($tag->id) , $post->tags->pluck('id')->toArray()) ? 'selected' : ''  }}> {{ $tag->name }} </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row pt-2">
                                            <div class="col">
                                                ...
                                                <textarea rows="2" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" id="description">{{ $post->description }}</textarea>
                                        ...
                                        <div class="row pt-2">
                                            <div class="col">
                                                ...
                                                <textarea rows="5" class="form-control" name="body" id="body" style="height: 20px"> {{ $post->body }} </textarea>
                                                @if ($errors->has('body'))
                                                    <span class="invalid-feedback d-block">
                                        ...
                                        <div class="row pt-2">
                                            ...
                                            <div class="col-sm-6">
                                                <img src="{{ asset("/storage/$post->images") }}" class="img-fluid img-thumbnail w-50 mt-2 m-auto" alt="{{ $post->title }}">
                                            </div>
                                        </div>
                                        <div class="row pt-4">
