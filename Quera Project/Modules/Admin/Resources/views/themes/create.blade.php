                    ...
                    <div class="card border-0">
                        <div class="card-header border-0 rounded">
                            <div class="float-right pt-1">
                                {{ __('admin::admin.create', ['value' => trans_choice('admin::admin.theme', 1)]) }}
                            </div>
                        ...
                        <div class="card-body pb-0">
                            <div class="row justify-content-center">
                                <div class="col-12">
                                    <form class="form-horizontal" action="{{ route('themes.store') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col">
                                        ...
                                        <div class="row justify-content-center pt-2">
                                            <div class="col-sm-6">
                                                <label for="file" class="form-label{{ $errors->has('file') ? ' text-danger' : '' }} mb-1"> {{ __('validation.attributes.file') }} </label>
                                                <input type="file" class="form-control form-control-sm{{ $errors->has('file') ? ' is-invalid' : '' }}" name="file" id="file" placeholder="تصویر را وارد کنید">
                                                @if ($errors->has('file'))
                                                    <span class="invalid-feedback d-block">
